...
def create_recharge_decline(df):
    """
    Create feature capturing decline in recharge amount
    between month 6 and month 8.
    """
...
def create_outgoing_call_decline(df):
    """
    Create feature capturing decline in outgoing call usage.
    """
...
def create_incoming_call_decline(df):
    """
    Create feature capturing decline in incoming call usage.
    """
...
def add_behavioral_features(df):
    """
    Wrapper function that creates all engineered features.
    """
